...
public class Ingresos {
    ...
    public void setIngresos_salida_productos(int ingresos_salida_productos) {
        this.ingresos_salida_productos = ingresos_salida_productos;
    }

    public int getIngresos_entrada_productos() {
        return ingresos_entrada_productos;
    }
    ...
    public void calculo_Inproductos_entrada(){
        
    }
    public void calculo_ganancia(){
